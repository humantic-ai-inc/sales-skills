# 07 - Run the deal and hand it over
...
## 37. Full deal briefing in one pass

**When:** You want everything known about a deal in a single answer.
...
## 38. Handover briefing for a colleague

**When:** Someone else is picking this up and should not start from zero.
...
## 39. Build an account plan skeleton
...
## 40. Prepare a QBR or check-in

**When:** A scheduled review with an existing customer.
...
## 41. Re-engage a dormant account
