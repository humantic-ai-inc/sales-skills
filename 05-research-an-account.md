...
## 25. Check whether research already exists

**When:** Always, before prompt 26.

```text
Do we already have Humantic research on [company name]?
```

**What you get back:** What has already been built, so you do not pay twice.


---

## 26. Start new account research
...
> Reports run in the background. They are usually ready in about two minutes, and occasionally take fifteen to twenty. Start one before a meeting rather than during it. If the company name alone does not resolve, supply the domain rather than letting it guess.

---

## 27. Get the executive summary
...
## 28. Pull the leadership section
...
## 29. Pull how they evaluate vendors
...
## 30. Pull the competitive picture
