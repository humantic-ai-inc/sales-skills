...
> Per-account signals hold roughly the last 60 days. Ask for six months and you will get 60 days' worth. The answer states the window it actually used, so read that line rather than assuming.

---

## 33. Signals across the whole book
...
> Large feeds arrive in pages. If there is more than one page, ask for the rest rather than treating the first page as the whole picture.

---

## 34. Turn a signal into a reason to reach out
...
## 35. Filter signals to what matters
