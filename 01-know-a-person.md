...
## 1. Build a profile and get an approach read
...
## 2. Get the two-minute version before a call
...
## 3. Improve a thin or low-confidence profile
...
## 4. Refresh someone who changed roles
...
> **Refresh or update?** Refresh re-pulls what is publicly out there, for someone whose situation changed. Update adds information you supply, for a profile that came back thin. They fix different problems, so pick the one that matches yours.

---

## 5. Get a profile in a format you can paste or share
...
## 6. Check what drives this person before you pitch
